...
export default function Atelier() {
  ...
  return (
    <div className="atelier-brand-home" id="top">
      ...
      <main>
        ...
        >
          <div className="me-hero-media" aria-hidden="true">
            ...
            <img src="/brand-home-2/atelier-hero-higgsfield-clean.png" alt="" width={1672} height={941} />
            ...
            {venues.map((venue, index) => (
              <article key={venue.name}>
                ...
                <div className="me-location-copy">
                  ...
                  <button onClick={() => openBooking()}>Book this studio <Arrow /></button>
                </div>
              </article>
            ))}
          </div>
      ...
      {bookingOpen && <SalonBooking brand="Atelier" theme="atelier" initialBootstrap={catalog.data} initialServiceId={bookingServiceId} onClose={() => setBookingOpen(false)} />}
    </div>
  );
}
